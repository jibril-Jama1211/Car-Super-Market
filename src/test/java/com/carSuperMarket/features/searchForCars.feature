...
Feature: Search for Cars
  ...
  Scenario Outline: Search for different cars on Home page
    ...
    Examples: 
      | Make | Model    | Trim              | MinPrice | MaxPrice | MinMonthlyPayment | VehicleAge | Mileage      | BodyType       | FuelType | NumOfDoors | NumOfSeats | carColours | TransmissionsTypes | Locations | AddedSince | IgnoreReservedCars | CarDepositOption | AnnualMileage | VerifyMake   |
      | BMW  | 1 Series | M Sport Shadow Ed | £16,000  | £19,000  | £50               | Any Year   | Up to 30,000 | All Body Types | Petrol   |          5 |          5 | White      | Automatic          | Any       | Any        | No                 | £500             | 8,000 miles   | BMW 1 SERIES |
